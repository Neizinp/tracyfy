                    ...
                    {activeTab === 'overview' && (
                        <>
                            <div style={{ marginBottom: 'var(--spacing-md)' }}>
                                <label htmlFor="edit-test-case-title" style={{ display: 'block', marginBottom: 'var(--spacing-xs)', fontSize: '0.875rem' }}>Title</label>
                                <input
                            ...
                            <div style={{ marginBottom: 'var(--spacing-md)' }}>
                                <label htmlFor="edit-test-case-description" style={{ display: 'block', marginBottom: 'var(--spacing-xs)', fontSize: '0.875rem' }}>Description</label>
                                <textarea
                            ...
                            <div style={{ marginBottom: 'var(--spacing-md)' }}>
                                <label htmlFor="edit-test-case-priority" style={{ display: 'block', marginBottom: 'var(--spacing-xs)', fontSize: '0.875rem' }}>Priority</label>
                                <select
                            ...
                            <div style={{ marginBottom: 'var(--spacing-md)' }}>
                                <label htmlFor="edit-test-case-status" style={{ display: 'block', marginBottom: 'var(--spacing-xs)', fontSize: '0.875rem' }}>Status</label>
                                <select
                            ...
                            <div style={{ marginBottom: 'var(--spacing-md)' }}>
                                <label htmlFor="edit-test-case-author" style={{ display: 'block', marginBottom: 'var(--spacing-xs)', fontSize: '0.875rem' }}>Author</label>
                                <input
