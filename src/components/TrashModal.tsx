        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: 'none',
                            border: 'none',
                            borderBottom: activeTab === 'requirements' ? '2px solid var(--color-accent)' : '2px solid transparent',
                            color: activeTab === 'requirements' ? 'var(--color-accent)' : 'var(--color-text-secondary)',
                            fontWeight: 500,
                            cursor: 'pointer'
                        }}
                    >
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: 'none',
                            border: 'none',
                            borderBottom: activeTab === 'usecases' ? '2px solid var(--color-accent)' : '2px solid transparent',
                            color: activeTab === 'usecases' ? 'var(--color-accent)' : 'var(--color-text-secondary)',
                            fontWeight: 500,
                            cursor: 'pointer'
                        }}
                    >
                                    ...
                                    <div key={req.id} style={{
                                        ...
                                        <div>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                                                <span style={{ fontFamily: 'monospace', fontWeight: 600, color: 'var(--color-accent)' }}>{req.id}</span>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-sm)' }}>
                                {deletedUseCases.map(uc => (
                                    <div key={uc.id} style={{
                                        ...
                                        <div>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                                                <span style={{ fontFamily: 'monospace', fontWeight: 600, color: 'var(--color-accent)' }}>{uc.id}</span>
                ...
                <div style={{
                    ...
                    Items in trash are not visible in the main view but are preserved until permanently deleted.
                </div>
            </div>
        </div>
    );
