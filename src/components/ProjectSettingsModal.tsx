            ...
            <div style={{
                ...
                <form onSubmit={handleSubmit} style={{ padding: 'var(--spacing-lg)', overflowY: 'auto' }}>
                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                        <label htmlFor="project-name" style={{ display: 'block', marginBottom: 'var(--spacing-xs)', fontSize: '0.875rem' }}>
                            Project Name
                        </label>
                        <input
                            type="text"
                    ...
                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                        <label htmlFor="project-description" style={{ display: 'block', marginBottom: 'var(--spacing-xs)', fontSize: '0.875rem' }}>
                            Description
                        </label>
                        <textarea
                    ...
                    <div style={{ marginTop: 'var(--spacing-lg)', display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                        ...
                        <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: 'var(--spacing-md)', marginTop: 'var(--spacing-sm)' }}>
                            <h4 style={{ fontSize: '0.875rem', fontWeight: 500, color: '#ef4444', marginBottom: 'var(--spacing-sm)' }}>Danger Zone</h4>
                            {!showDeleteConfirm ? (
                                <button
                                    type="button"
                                ...
                                <div style={{ backgroundColor: '#fef2f2', padding: 'var(--spacing-md)', borderRadius: '6px', border: '1px solid #fecaca' }}>
                                    <p style={{ fontSize: '0.875rem', color: '#991b1b', marginBottom: 'var(--spacing-sm)' }}>
