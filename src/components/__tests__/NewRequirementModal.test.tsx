...
describe('NewRequirementModal', () => {
    ...
    it('should call onSubmit with correct data when creating requirement', () => {
        ...
        const reqTextEditor = screen.getByTestId('markdown-editor-Requirement Text').querySelector('textarea');
        if (reqTextEditor) {
    ...
    it('should handle optional fields correctly', () => {
        ...
        // Should be called with undefined for optional empty fields
        expect(defaultProps.onSubmit).toHaveBeenCalledWith(
            expect.objectContaining({
