...
export const LinkModal: React.FC<LinkModalProps> = ({
  ...
  const findProjectForArtifact = (id: string): Project | undefined => {
    return projects.find(
      (p) =>
        p.requirementIds.includes(id) || p.useCaseIds.includes(id) || p.testCaseIds.includes(id)
    );
  };
                  ...
                  filteredArtifacts.map((artifact) => {
                    ...
                    return (
                      <div
                        ...
                        className={`p-3 border-b border-gray-700 last:border-0 cursor-pointer transition-colors flex items-center justify-between ${
                          selectedTargetId === artifact.id
