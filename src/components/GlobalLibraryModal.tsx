            ...
            <div className="bg-gray-900 rounded-lg w-full max-w-6xl h-[85vh] flex flex-col shadow-2xl border border-gray-700">
                ...
                <div className="p-6 border-b border-gray-700 flex justify-between items-center bg-gray-800 rounded-t-lg">
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mt-1">Browse and add artifacts from the global pool to your project.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-6 h-full">
                        ...
                        <div className="flex flex-col bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                            <div className="p-3 bg-gray-700/50 border-b border-gray-700 flex justify-between items-center">
                                ...
                                <span className="text-xs bg-gray-700 px-2 py-0.5 rounded text-gray-300">{filteredReqs.length}</span>
                            </div>
                                        ...
                                        >
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="text-sm text-gray-200 font-medium truncate">{req.title}</div>
                                                    <div className="text-xs text-gray-400 line-clamp-2 mt-1">{req.description}</div>
                                                </div>
                                            </div>
                                        </div>
                                    );
                                })}
                                {filteredReqs.length === 0 && <div className="text-center text-gray-500 py-8 italic">No requirements found</div>}
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                            <div className="p-3 bg-gray-700/50 border-b border-gray-700 flex justify-between items-center">
                                ...
                                <span className="text-xs bg-gray-700 px-2 py-0.5 rounded text-gray-300">{filteredUCs.length}</span>
                            </div>
                            <div className="flex-1 overflow-y-auto p-2 space-y-2">
                                {filteredUCs.map(uc => {
                                        ...
                                        >
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="text-sm text-gray-200 font-medium truncate">{uc.title}</div>
                                                </div>
                                            </div>
                                        </div>
                                    );
                                })}
                                {filteredUCs.length === 0 && <div className="text-center text-gray-500 py-8 italic">No use cases found</div>}
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                            <div className="p-3 bg-gray-700/50 border-b border-gray-700 flex justify-between items-center">
                                ...
                                <span className="text-xs bg-gray-700 px-2 py-0.5 rounded text-gray-300">{filteredTCs.length}</span>
                            </div>
                            <div className="flex-1 overflow-y-auto p-2 space-y-2">
                                {filteredTCs.map(tc => {
                                        ...
                                        >
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="text-sm text-gray-200 font-medium truncate">{tc.title}</div>
                                                </div>
                                            </div>
                                        </div>
                                    );
