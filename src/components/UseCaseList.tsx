...
export const UseCaseList: React.FC<UseCaseListProps> = ({
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            ...
            case 'implemented': return 'rgba(59, 130, 246, 0.2)';
            case 'approved': return 'rgba(168, 85, 247, 0.2)';
    ...
    if (useCases.length === 0) {
        return (
            <div style={{
                ...
                <h3 style={{ marginTop: 'var(--spacing-md)', fontSize: '1.125rem', fontWeight: 600 }}>No Use Cases Yet</h3>
                            ...
                            <div style={{
                                ...
                                {useCase.description && (
                                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                                        ...
                                        <p style={{ marginTop: '4px', color: 'var(--color-text-secondary)', fontSize: '0.875rem' }}>
                                            {useCase.description}
                                        </p>
                                    </div>
                                )}
                                ...
                                {useCase.preconditions && (
                                    <div style={{ marginBottom: 'var(--spacing-md)' }}>
                                        ...
                                        <p style={{ marginTop: '4px', color: 'var(--color-text-secondary)', fontSize: '0.875rem', whiteSpace: 'pre-wrap' }}>
                                            {useCase.preconditions}
                                        </p>
                                    </div>
                                )}
                                ...
                                {linkedReqs.length > 0 && (
                                    <div>
                                        <strong style={{ fontSize: '0.875rem' }}>Linked Requirements ({linkedReqs.length}):</strong>
