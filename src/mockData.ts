...
export const mockRequirements: Requirement[] = [
    ...
    // Data Management Requirements
    {
        ...
        rationale: 'Encryption protects sensitive data from unauthorized access and meets compliance requirements.',
        status: 'approved',
        priority: 'high',
        parentIds: [],
        author: 'Emily Davis',
