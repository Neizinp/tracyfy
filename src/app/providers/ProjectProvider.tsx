...
interface ProjectContextValue {
    ...
    addToProject: (artifacts: { requirements: string[], useCases: string[], testCases: string[], information: string[] }, targetProjectId?: string) => Promise<void>;
...
export const ProjectProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const currentProject = projectManager.projects.find(p => p.id === projectManager.currentProjectId) || projectManager.projects[0];
